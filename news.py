...
# Two initial sources for testing. You can add more later.
SOURCES = [
    {
        "name": "banki",
        "type": "html",
        "url": "https://www.banki.ru/news/",
        "selector": "a.WidgetNews__title",  # Update if site changes
...
def fetch_article_text(url: str) -> str:
    """Fetch page and try to extract readable text using readability-lxml."""
    try:
